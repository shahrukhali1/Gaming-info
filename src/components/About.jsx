    ...
    <div>
      ...
      <section className='text-white body-font bg-[#291D24]'>
        <div className='container px-5 py-24 mx-auto'>
          ...
          >
            <div className='p-4 lg:w-1/2 m-auto'>
              <div className='h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left'>
                ...
                <div className='flex-grow sm:pl-8'>
                  ...
                  <p className='mb-4 font-thin'>
                    ...
                    up for a challenge. I've been working on front end mainly as
                    a Front-end React developer for almost 2 years now. I also
                    have experience in working with Node.js, Express.js, and
                    MongoDB.
                  </p>
